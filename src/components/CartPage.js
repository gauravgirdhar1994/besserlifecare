        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-slate-500">
              <Link to="/" className="text-pink-600 hover:text-pink-700 underline">
                Continue browsing
              </Link>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-pink-100 p-6 md:p-8">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-display font-semibold text-pink-800">
                  Cart Items
                </h2>
                <button
                  onClick={clearCart}
              ...
              <div className="space-y-4">
                {items.map((item) => (
                  <div key={item.id} className="flex items-center space-x-4 p-4 bg-pink-50 rounded-xl">
                    <div className="w-20 h-20 bg-gradient-to-br from-pink-100 to-coral-100 rounded-lg flex items-center justify-center flex-shrink-0">
                      <img
                        src={item.image}
                        alt={item.name}
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-lg font-display font-semibold text-pink-800 mb-1">
                        {item.name}
                      </h3>
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            className="w-8 h-8 bg-white border border-pink-200 rounded-full flex items-center justify-center text-pink-600 hover:bg-pink-50 transition-colors"
                          >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-pink-100 p-6 md:p-8 sticky top-8">
              ...
              <div className="space-y-3">
                <Link
                  to="/checkout"
                  className="block w-full bg-gradient-to-r from-pink-500 to-coral-500 text-white text-center py-4 px-6 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
                >
                  Proceed to Checkout
                </Link>
                ...
                <Link
                  to="/products"
                  className="block w-full bg-white text-pink-600 text-center py-3 px-6 rounded-xl font-semibold border-2 border-pink-200 hover:border-pink-300 hover:bg-pink-50 transition-all duration-300"
                >
                  Continue Shopping
                </Link>
              </div>
              ...
              <div className="mt-6 p-4 bg-pink-50 rounded-xl">
                ...
                <div className="flex items-center space-x-2 text-sm text-pink-700 mt-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                  </svg>
