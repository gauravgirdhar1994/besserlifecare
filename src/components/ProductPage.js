...
const ProductPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-cream-50 to-coral-50">
      <Header />
      ...
      <div className="pt-20 pb-16 px-4 md:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <nav className="flex items-center space-x-2 text-sm text-slate-600 mb-8">
            <button onClick={() => navigate('/')} className="hover:text-pink-600 transition-colors">
              Home
            </button>
            <span>/</span>
            <button onClick={() => navigate('/#products')} className="hover:text-pink-600 transition-colors">
              Products
            </button>
            <span>/</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div className="space-y-6">
              {/* Main Image */}
              <div className="relative bg-white rounded-2xl p-8 shadow-lg border border-pink-100">
              ...
              <div className="grid grid-cols-4 gap-4">
                {product.images.map((image, index) => (
                  <div key={index} className="bg-white rounded-xl p-4 shadow-md border border-pink-100 cursor-pointer hover:shadow-lg transition-shadow">
                    <img
                      src={image}
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <h1 className="text-3xl md:text-4xl font-display font-bold text-pink-900 mb-4">
                  {product.name}
                </h1>
              ...
              {/* Quantity */}
              <div>
                <h3 className="text-lg font-semibold text-pink-800 mb-3">Quantity</h3>
                <div className="flex items-center space-x-3">
                  <button
                    onClick={() => setQuantity(Math.max(1, quantity - 1))}
                    className="w-10 h-10 bg-white border border-pink-200 rounded-lg flex items-center justify-center text-pink-600 hover:bg-pink-50 transition-colors"
                  >
              ...
              <div className="space-y-4">
                <button
                  ...
                  className="w-full bg-pink-500 text-white py-4 px-6 rounded-2xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isAddingToCart ? (
                ...
                <button
                  ...
                  disabled={isAddingToCart}
                  className="w-full bg-gradient-to-r from-pink-500 to-coral-500 text-white py-4 px-6 rounded-2xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Buy Now
                </button>
              </div>
          ...
          <div className="mt-20">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-pink-100">
              ...
              {activeTab === 'description' && (
                <div className="space-y-6">
                  <h3 className="text-2xl font-display font-semibold text-pink-800 mb-4">
                    Product Description
                  </h3>
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-pink-800 mb-3">Key Benefits</h4>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {product.ingredients.map((ingredient, index) => (
                      <div key={index} className="bg-pink-50 rounded-xl p-4 border border-pink-100">
                        <h4 className="font-semibold text-pink-800 mb-2">{ingredient}</h4>
                  ...
                  <div className="space-y-4">
                    {product.howToUse.map((step, index) => (
                      <div key={index} className="flex items-start space-x-4">
                        <div className="w-8 h-8 bg-pink-500 text-white rounded-full flex items-center justify-center font-semibold text-sm flex-shrink-0">
                          {index + 1}
                        </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {Object.entries(product.specifications).map(([key, value]) => (
                      <div key={key} className="bg-pink-50 rounded-xl p-4 border border-pink-100">
                        <h4 className="font-semibold text-pink-800 mb-2 capitalize">
              ...
              {activeTab === 'reviews' && (
                <div className="space-y-6">
                  ...
                  <div className="text-center py-12">
                    ...
                    <button className="bg-pink-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-pink-600 transition-colors">
                      Write a Review
                    </button>
                  </div>
                </div>
          ...
          {/* Related Products */}
          <div className="mt-20">
            <h2 className="text-3xl font-display font-bold text-pink-900 mb-8 text-center">
              You Might Also Like
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[1, 2, 3].map((id) => (
                <div key={id} className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-pink-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                  <div className="bg-gradient-to-br from-pink-50 to-coral-50 rounded-xl p-4 mb-4">
                    <img
                  ...
                  <h3 className="font-display font-semibold text-pink-800 mb-2">
                    Related Product {id}
                  </h3>
