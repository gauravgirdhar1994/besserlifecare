          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <button
                  ...
                  className={`flex items-center space-x-2 px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                    selectedCategory === category.id
                      ? 'bg-gradient-to-r from-pink-500 to-coral-500 text-white shadow-lg'
            ...
            <div className="flex items-center space-x-3">
              ...
              <select
                ...
                className="px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-pink-400 focus:border-transparent text-sm"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {sortedProducts.map((product) => (
            <div key={product.id} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
              {/* Product Image */}
              <div className="h-48 bg-gradient-to-br from-pink-100 to-coral-100 flex items-center justify-center">
              ...
              <div className="p-6">
                ...
                <div className="flex space-x-2">
                  <Link
                    ...
                    className="flex-1 bg-gradient-to-r from-pink-500 to-coral-500 text-white py-2 px-4 rounded-lg font-medium text-center hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300"
                  >
                    View Details
                  </Link>
                  <button className="w-10 h-10 bg-slate-100 text-slate-600 rounded-lg flex items-center justify-center hover:bg-pink-100 hover:text-pink-600 transition-all duration-300">
        ...
        {sortedProducts.length === 0 && (
          <div className="text-center py-16">
            ...
            <button
              ...
              className="bg-gradient-to-r from-pink-500 to-coral-500 text-white px-6 py-3 rounded-lg font-medium hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300"
            >
              View All Products
            </button>
          </div>
