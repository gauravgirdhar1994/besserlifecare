      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-12 md:mb-16">
          {products.map((product) => (
            <div
              key={product.id}
                             className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 shadow-lg border border-green-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group relative overflow-hidden"
            ...
            >
              ...
              <div className="relative mb-4 md:mb-6">
                                 <div className="aspect-square bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl overflow-hidden">
                  <img
                    src={product.image}
                    alt={product.name}
